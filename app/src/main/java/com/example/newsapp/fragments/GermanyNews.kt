...
import kotlinx.android.synthetic.main.germany_news.*
...
class GermanyNews : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.germany_news, container, false)
        getData()
        return view
    }
